...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer(){
        ...
        checkintime  .setBounds(200,320,400,20);
        checkintime.setFont(new Font("Raleway",Font.PLAIN, 18));
        add(checkintime  );
        
        JLabel lbladvance = new JLabel("Advance");
        lbladvance  .setBounds(35,360,100,20);
        lbladvance  .setFont(new Font("Raleway",Font.PLAIN, 20));
        add(lbladvance  );
       ...
       back.addActionListener(this);
        ...
        image.setBounds(370 , 30 , 500, 470);
        add(image);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == add){
            ...
            try{
                String query = "insert into customer values('"+id+"','"+number+"','"+name+"','"+gender+"','"+country+"','"+room+"','"+time+"','"+advance+"')";
