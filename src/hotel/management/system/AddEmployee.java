...
public class  AddEmployee extends JFrame implements ActionListener {
    ...
    AddEmployee() {
        ...
        lblname.setFont(new Font("Tohama", Font.PLAIN, 17));
        add(lblname);
        ...
        lblage.setFont(new Font("Tohama", Font.PLAIN, 17));
        add(lblage);
        ...
        lblgender.setFont(new Font("Tohama", Font.PLAIN, 17));
        add(lblgender);
        ...
        lbljob.setFont(new Font("Tohama", Font.PLAIN, 17));
        add(lbljob);
        ...
        lblsalary.setFont(new Font("Tohama", Font.PLAIN, 17));
        add(lblsalary);
        ...
        lblphone.setFont(new Font("Tohama", Font.PLAIN, 17));
        add(lblphone);
        ...
        lblemail.setFont(new Font("Tohama", Font.PLAIN, 17));
        add(lblemail);
        ...
        lblaadhar.setFont(new Font("Tohama", Font.PLAIN, 17));
        add(lblaadhar);
