...
public class Checkout extends JFrame implements ActionListener{
    ...
    Choice ccustomer;
    JLabel lblroomnumber,lblcheckin, lblcheckintime,lblcheckouttime, lblcheckout;
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == checkout){
            ...
            String query2 = "update from customer where availability = 'Available' where roomnumber = '"+lblroomnumber.getText()+"' ";
